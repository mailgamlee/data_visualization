...
df_city_i = df_city.columns.tolist()
df_city_i.insert(2,'hjust1')
df_city_i.insert(2,'hjust2')
df_city = df_city.reindex(columns = df_city_i)

for i in range(28):
    if df_city['variable'][i] == "orange":
        df_city['hjust1'][i] = -width
    elif df_city['variable'][i] == "apple":
        df_city['hjust1'][i] = -width/2
    elif df_city['variable'][i] == "banana":
        df_city['hjust1'][i] = 0
    else:
        df_city['hjust1'][i] = width/2
...
for i in range(28):
    if df_city['variable'][i] == "orange":
        df_city['hjust2'][i] = -width/2
    elif df_city['variable'][i] == "apple":
        df_city['hjust2'][i] = 0
    elif df_city['variable'][i] == "banana":
        df_city['hjust2'][i] = width/2
    else:
        df_city['hjust2'][i] = width
