...
melt_df['variable']=melt_df['variable'].astype(CategoricalDtype(categories= Sum_df.index,ordered=True))
...
melt_df['variable']=melt_df['variable'].astype(CategoricalDtype(categories= meanCol_df.index,ordered=True))
